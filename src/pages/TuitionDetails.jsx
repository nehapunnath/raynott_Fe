...
import BasicInfo from '../components/Tuition/BasicInfo';
import FeeStructure from '../components/Tuition/FeeStructure';
import Contact from '../components/Tuition/Contact';
import Review from '../components/Tuition/Review';
...
const TuitionDetails = () => {
    ...
    const tuitionCenter = {
        ...
        established: 2018,
        classes: ['1st to 10th (All Subjects)', '11th-12th (Science & Commerce)'],
        subjects: ['Mathematics', 'Science', 'Social Studies', 'English', 'Accountancy', 'Economics'],
        batchSize: '5-8 students per batch',
        facilities: ['Personal Attention', 'Regular Tests', 'Doubt Clearing', 'Study Materials'],
        photos: [
    ...
    const similarTuitionCenters = [
        { name: 'Scholar\'s Home Tuition', address: 'Koramangala', rating: 4.3, image: 'https://images.unsplash.com/photo-1549861833-c5932fd19229?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80', link: '/tuition/scholars-home' },
        { name: 'Genius Tuition Point', address: 'BTM Layout', rating: 4.2, image: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6a3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80', link: '/tuition/genius' },
        { name: 'Smart Learners Academy', address: 'JP Nagar', rating: 4.5, image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80', link: '/tuition/smart-learners' },
    ];
    ...
    const navigateImages = (direction) => {
        let newIndex;
        if (direction === 'prev') {
            newIndex = currentImageIndex === 0 ? tuitionCenter.photos.length - 1 : currentImageIndex - 1;
        } else {
            newIndex = currentImageIndex === tuitionCenter.photos.length - 1 ? 0 : currentImageIndex + 1;
        }
        setSelectedImage(tuitionCenter.photos[newIndex]);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
            ...
            >
                ...
                <img
                    src={tuitionCenter.image}
                    alt={tuitionCenter.name}
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-8 text-white">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                        <div className="flex items-center bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full">
                            ...
                            <span>{tuitionCenter.address}</span>
                        </div>
                        <div className="flex items-center bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full">
                            <IoMdTime className="mr-1 text-orange-300" />
                            <span>Est. {tuitionCenter.established}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between">
                        <div className="flex items-center space-x-6">
                            <div className="flex items-center text-amber-300 text-xl">
                                <FaStar className="mr-1" /> {tuitionCenter.rating}
                            </div>
                            <p className="text-xl font-semibold text-white">{tuitionCenter.fees}</p>
                        </div>

                        <motion.a
                            href={`tel:${tuitionCenter.phone}`}
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
            ...
            >
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div className="flex overflow-x-auto scrollbar-hide justify-center bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-1 shadow-inner">
                        {['Basic Info', 'Classes', 'Fee Structure', 'Contact', 'Reviews'].map((section) => (
                            <motion.button
                                key={section}
                ...
                <div className="w-full lg:w-2/3 space-y-8">
                    ...
                    >
                        <div className="p-6">
                            ...
                            <BasicInfo tuitionCenter={tuitionCenter} />
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="font-semibold text-lg text-gray-700 mb-3">Classes Covered</h3>
                                    <ul className="space-y-2">
                                        {tuitionCenter.classes.map((cls, index) => (
                                ...
                                <div>
                                    <h3 className="font-semibold text-lg text-gray-700 mb-3">Subjects Offered</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {tuitionCenter.subjects.map((subject, index) => (
                            ...
                            <div className="mt-6 bg-orange-50 p-4 rounded-lg">
                                <p className="font-medium text-orange-800">Batch Size: <span className="text-gray-700">{tuitionCenter.batchSize}</span></p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <FeeStructure tuitionCenter={tuitionCenter} />
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <Contact tuitionCenter={tuitionCenter} />
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <Review tuitionCenter={tuitionCenter} />
                        </div>
                    </motion.div>
                </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <option value="senior">Senior (11th-12th)</option>
                                </motion.select>
                                <motion.textarea
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{tuitionCenter.established}</p>
                                    </div>
                                </div>
                                <div className="flex items-center">
                                    <div className="p-2 bg-orange-100 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{tuitionCenter.classes.join(', ')}</p>
                                    </div>
                                </div>
                                <div className="flex items-center">
                                    <div className="p-2 bg-orange-100 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{tuitionCenter.batchSize}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            >
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-2">Similar Tuition Centers</h2>
                <p className="text-lg text-center text-gray-600 mb-8">Discover other great tuition options in Bengaluru</p>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {similarTuitionCenters.map((center, index) => (
                        <motion.div
                            key={index}
                            whileHover={{ y: -8 }}
            ...
            {selectedImage && (
                ...
                >
                    ...
                    <motion.img
                        src={selectedImage}
                        alt={`${tuitionCenter.name} - Photo ${currentImageIndex + 1}`}
                    ...
                    <div className="absolute bottom-4 left-0 right-0 text-center text-white">
                        Photo {currentImageIndex + 1} of {tuitionCenter.photos.length}
                    </div>
                </motion.div>
            )}
            {/* <Footer/> */}
