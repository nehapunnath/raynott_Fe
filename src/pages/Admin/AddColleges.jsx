        ...
        const AddColleges = () => {
            ...
            const handleSubmit = () => {
                ...
                alert('College data submitted! Check console for details.');
            };
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <motion.input
                                        type="text"
                                        name="typeOfCollege"
                                        placeholder="Type of College (e.g., Private)"
                                    ...
                                    <motion.input
                                        type="text"
                                        name="courses"
                                        placeholder="Courses Offered (e.g., B.Tech, M.Tech, MBA)"
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-2">
                                    {['Advanced Labs', 'Digital Library', 'Hostel', 'Sports Complex', 'Cafeteria'].map(facility => (
