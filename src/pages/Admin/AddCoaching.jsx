        ...
        import { FaBookOpen, FaSearch, FaMapMarkerAlt, FaGraduationCap, FaRupeeSign, FaSchool, FaFlask, FaBook, FaChalkboardTeacher, FaVideo, FaFirstAid, FaWifi, FaLink, FaClipboardList, FaPhone } from 'react-icons/fa';
        ...
        const AddCoaching = () => {
            ...
            const handleImageUpload = (e, type) => {
                ...
                if (type === 'centerImage') {
                    if (files.length > 0) {
                        setFormData(prev => ({ ...prev, centerImage: URL.createObjectURL(files[0]) }));
                    }
            ...
            const handleSubmit = () => {
                ...
                alert('Tuition Center data submitted! Check console for details.');
            };
            ...
            return (
                <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
                    ...
                    >
                        <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">Add New Coaching/Tuition Center</h1>
                        <div className="bg-white rounded-2xl shadow-xl p-8 border border-orange-100">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <motion.input
                                        type="text"
                                        name="typeOfcoaching"
                                        placeholder="Type of coaching (e.g., Academic Support)"
                                        value={formData.typeOfTuition}
                                        onChange={handleInputChange}
                                        className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                                        whileFocus={{ scale: 1.02 }}
                                    />
                            ...
                            >
                                <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                                    <span className="w-2 h-8 bg-orange-600 rounded-full mr-3"></span>
                                    Tuition Center Gallery (Max 6 Images)
                                </h2>
                                <motion.input
                                    type="file"
                                    accept="image/*"
