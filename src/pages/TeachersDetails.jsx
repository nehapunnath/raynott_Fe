...
import {FaChalkboardTeacher, FaSearch, FaStar, 
  FaPhone, 
  FaMapMarkerAlt, 
  FaGraduationCap,
  FaChevronLeft,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
      ...
      >
        ...
        <p className="text-lg text-center text-gray-600 mb-8">Discover other great educators in Bengaluru</p>
