...
const Contact = ({ puCollege: puCollegeProp }) => {
    ...
    const fetchCollegeData = async () => {
      try {
        ...
        const mappedCollege = {
          ...
          address: collegeData.address && collegeData.city
            ? `${collegeData.address}, ${collegeData.city}, Karnataka, India`
            : collegeData.address || 'Not specified',
          phone: collegeData.phone || '+91 9876543210',
          email: collegeData.email || 'info@college.edu.in',
          website: collegeData.website || 'https://www.college.edu.in',
          ...
          googleMapsEmbedUrl: collegeData.googleMapsEmbedUrl ||
            `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.008888888889!2d77.63964131572784!3d13.11296749083023!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae191736000000%3A0x0000000000000000!2s${encodeURIComponent(
        ...
        console.error('Error fetching PU College data in Contact:', err);
        setError('Failed to load contact information. Using fallback data.');
        // Fallback to prop or default data
        setPUCollege(
          puCollegeProp || {
            name: 'Brilliant PU College',
            address: '456 Science Avenue, Bengaluru, Karnataka, India',
            phone: '+91 9876543210',
            email: 'info@brilliantpu.edu.in',
            website: 'https://www.brilliantpu.edu.in',
            socialMedia: {
              facebook: 'https://facebook.com',
              twitter: 'https://twitter.com',
              instagram: 'https://instagram.com',
  ...
  // Prepare contactDetails from puCollege data
  const contactDetails = {
    name: puCollege?.name || 'Brilliant PU College',
    address: puCollege?.address || '456 Science Avenue, Bengaluru, Karnataka, India',
    phone: puCollege?.phone || '+91 9876543210',
    email: puCollege?.email || 'info@brilliantpu.edu.in',
    website: puCollege?.website || 'https://www.brilliantpu.edu.in',
    socialMedia: puCollege?.socialMedia || {
      facebook: 'https://facebook.com',
      twitter: 'https://twitter.com',
      instagram: 'https://instagram.com',
    },
