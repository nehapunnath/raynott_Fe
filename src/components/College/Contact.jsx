...
const Contact = () => {
  ...
  const contactDetails = {
    ...
    website: college?.website || 'https://example.com',
    socialMedia: {
      facebook: college?.socialMedia?.facebook || 'https://facebook.com',
      twitter: college?.socialMedia?.twitter || 'https://twitter.com',
      instagram: college?.socialMedia?.instagram || 'https://instagram.com',
    },
    googleMapsEmbedUrl:
        ...
        >
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-gray-700">College Name</h3>
